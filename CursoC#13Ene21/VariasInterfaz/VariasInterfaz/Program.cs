...
namespace VariasInterfaz
{
    class Program
    {
        static void Main(string[] args)
        {
            Console.WriteLine("VArias Interfaces video 49,50 - Ambiguegad ");
            ...
            objBallena.nadar();
            // YA NO es visible por la implmentacion de ambiguedad de dos mëtodos en Clase Caballo
          //Console.WriteLine("INTERFAZ::Número Patas Caballo Babieca  " + objCaballo.NumeroPatas());  ///Marca ERROR
            // utiliza principio sustitución "es_un"
            IMamiferoTerrestre IobjCaballo = objCaballo;  //Caballo es_un MamiferoTerrestre
                                                          //Utilizar el objeto Mamifero Terrestre para llamar el método Numero patas de la Interfaz.
            Console.WriteLine("INTERFAZ::Número Patas Caballo Babieca  " + IobjCaballo.NumeroPatas());  ///quitar ERROR
            ISaltoPata IobjCaballo1 = objCaballo;  //Caballo es_un MamiferoTerrestre
                                                          //Utilizar el objeto Mamifero Terrestre para llamar el método Numero patas de la Interfaz.
            Console.WriteLine("INTERFAZ::Nro.Patas Salta Caballo Babieca  " + IobjCaballo1.NumeroPatas());  ///quitar ERROR
...
/// //////////////////////////////////////////////////////////////
/// RESTRICCIONES
/// NO permite definir campos var en Interfaz, SOLO métodos.
/// NO permite definir contructores.
/// NO permite definir destructores.
/// NO se pueden especificar modificadores de acceso en métodos(
/// ((((((((((todos son public implicitamente.)
/// NO se pueden anidar clases, NI otro tipo de estructuras en la Interfaz.
/// ///////////////////////////////////////////////////////////////////////////////